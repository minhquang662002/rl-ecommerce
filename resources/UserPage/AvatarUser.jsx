...
const AvatarUser = (props) => {
  ...
  const { avt_user }= useContext(ContextForUser)
  ...
  return (
    <div className="u_avt" style={{display: 'flex', justifyContent: 'center',alignItems: 'center'}}>
        <div style={{width: '100%', position: 'relative', display: 'flex', justifyContent: 'center', alignItems: 'center'}}>
            ...
            <div className="igrate" style={{position: "absolute", bottom: 0, left: "50%", transform: "translate(-50%,0)", cursor: "pointer", zIndex: 9999999}}>
