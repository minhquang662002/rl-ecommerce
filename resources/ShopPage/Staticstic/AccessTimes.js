...
const AccessTimes = (props) => {
  return (
    <div className='fwekpawawa' style={{flex: "1 1 0", height: "100%", padding: 5, boxShadow: "rgba(99, 99, 99, 0.2) 0px 2px 8px 0px", borderRadius: 8, margin: 8, borderTop: "4px solid #ffa500"}}>
        ...
        <div className='ksekopwkqopwo'  style={{width: "100%", display: "flex", alignItems: 'center', flexDirection: "row", width: "100%", justifyContent: "space-between"}}>
            ...
            <div className='ewoeoapskow' style={{fontSize: 13, color: "rgb(89 89 89)"}}>
                1972,84%
            </div>
        </div>
    </div>
